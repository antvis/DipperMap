import React, { createContext, useState, useEffect, useContext, forwardRef, createElement, useMemo, useCallback, memo, useRef } from 'react';
import { AMapScene, MapboxScene, PointLayer as PointLayer$1, LineLayer as LineLayer$1, PolygonLayer as PolygonLayer$1, HeatmapLayer } from '@antv/l7-react';
import { Dropdown, Menu, Radio, Button, Typography, Space, Modal, Form, Input, Upload, message, Tag, Tabs, Drawer, Table, Tooltip, Popconfirm, Empty, Spin, Select, Slider, InputNumber, Checkbox, Popover, Collapse, Switch, ConfigProvider } from 'antd';
...
var MapModelContext = /*#__PURE__*/createContext();
...
var MapContext = function MapContext(_ref) {
  ...
  var _useState = useState((_localStorage$getItem = localStorage.getItem(LOCAL_STORAGE_KEY.MAP_THEME)) !== null && _localStorage$getItem !== void 0 ? _localStorage$getItem : MAP_THEME_LIST[0].value),
      _useState2 = _slicedToArray(_useState, 2),
      mapTheme = _useState2[0],
      setMapTheme = _useState2[1];

  var _useState3 = useState((_localStorage$getItem2 = localStorage.getItem(LOCAL_STORAGE_KEY.MAP_TYPE)) !== null && _localStorage$getItem2 !== void 0 ? _localStorage$getItem2 : MAP_TYPES[0].value),
...
var AppMap = function AppMap(_ref) {
  ...
  var _useContext = useContext(MapModelContext),
      mapTheme = _useContext.mapTheme;

  var MapScene = map === 'amap' ? AMapScene : MapboxScene;
  return /*#__PURE__*/React.createElement(MapScene, {
    className: className,
    map: {
...
var EditOutlined$2 = /*#__PURE__*/forwardRef(EditOutlined$1);
...
var EnterOutlined$2 = /*#__PURE__*/forwardRef(EnterOutlined$1);
...
var InboxOutlined$2 = /*#__PURE__*/forwardRef(InboxOutlined$1);
...
var RightOutlined$2 = /*#__PURE__*/forwardRef(RightOutlined$1);
...
var AppControlItem = function AppControlItem(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: classnames((_classnames = {}, _defineProperty(_classnames, styles$1.appControlItemName, true), _defineProperty(_classnames, styles$1.appControlItemNameActive, active), _classnames))
  }, icon && /*#__PURE__*/React.createElement("span", {
    className: styles$1.appControlItemIcon
  }, icon), text, /*#__PURE__*/React.createElement(DownOutlined$2, null))) : /*#__PURE__*/React.createElement("div", {
    className: classnames((_classnames2 = {}, _defineProperty(_classnames2, styles$1.appControlItemName, true), _defineProperty(_classnames2, styles$1.appControlItemNameActive, active), _classnames2)),
...
function MapTheme() {
  ...
  return /*#__PURE__*/React.createElement(AppControlItem, {
    text: "\u5730\u56FE\u4E3B\u9898",
    icon: /*#__PURE__*/React.createElement("i", {
      className: "dpiconfont dpicon-ditu"
    }),
    dropdown: /*#__PURE__*/React.createElement(Menu, null, (mapType === 'amap' ? MAP_THEME_LIST : MAPBOX_THEME_LIST).map(function (item) {
...
function MapType() {
  ...
  return /*#__PURE__*/React.createElement(AppControlItem, {
    ...
    dropdown: /*#__PURE__*/React.createElement(Menu, null, MAP_TYPES.map(function (item) {
      return /*#__PURE__*/React.createElement(Menu.Item, {
        key: item.value,
        onClick: function onClick(_ref) {
          var key = _ref.key;
...
var GlobalModelContext = /*#__PURE__*/createContext();
...
var Preview = function Preview() {
  var _useContext = useContext(GlobalModelContext),
      setIsPreview = _useContext.setIsPreview;

  return /*#__PURE__*/React.createElement("div", {
    className: classnames([styles$1.appControlItem, styles$1.appControlItemBtn]),
    onClick: function onClick() {
      return setIsPreview(true);
    }
  }, /*#__PURE__*/React.createElement("i", {
    className: classnames(['dpiconfont', 'dpicon-yulan', styles$1.appControlItemIcon])
  }), /*#__PURE__*/React.createElement("span", null, "\u9884\u89C8"));
};
...
function AppControl(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: className
  }, /*#__PURE__*/React.createElement(AppControlGroup, null, /*#__PURE__*/React.createElement(MapTheme, null), /*#__PURE__*/React.createElement(MapType, null), /*#__PURE__*/React.createElement(Preview, null)));
}
...
var AppSidebar = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  return (
    ...
    React.createElement("div", {
      ref: ref,
      className: classnames([styles$2.appSidebarContainer, isHidden ? styles$2.hide : styles$2.show, className])
    }, /*#__PURE__*/React.createElement("div", {
      className: classnames(_defineProperty({}, styles$2.appSidebar, true))
    }, children, /*#__PURE__*/React.createElement(Button, {
      className: styles$2.appSidebarToggleBtn,
      icon: isHidden ? /*#__PURE__*/React.createElement(RightOutlined$2, null) : /*#__PURE__*/React.createElement(LeftOutlined$2, null),
      onClick: function onClick() {
...
var AppHeader = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
...
var getRandomId = function getRandomId() {
  ...
  if (prefix) {
    return "".concat(prefix, "-").concat(v4());
  }
...
// @ts-ignore
var store = new IdbKvStore('dipperView');
...
var DatasetModelContext = /*#__PURE__*/createContext();
...
var DatasetContext = function DatasetContext(_ref) {
  ...
  var selectDataset = useMemo(function () {
    if (!selectDatasetId) {
      return null;
    }
  ...
  return /*#__PURE__*/React.createElement(Provider$2, {
    value: {
...
var useDataset = function useDataset() {
  ...
  var copyDataset = useCallback(function (dataset) {
  ...
  var getTargetDataset = useCallback(function (datasetId) {
  ...
  var getNewDatasetFields = useCallback(function (data) {
    if (!data.length) {
      return [];
    }
  ...
  if (Array.isArray(originData)) {
    ...
    try {
      if (originData.trim().startsWith('[') && originData.trim().endsWith(']')) {
        ...
        data = (_papaparse$parse$data = papaparse.parse(originData, {
          header: true,
          skipEmptyLines: true
...
var AddDatasetModal = function AddDatasetModal(_ref) {
  ...
  var _useState = useState(DEFAULT_FORM),
      _useState2 = _slicedToArray(_useState, 2),
      form = _useState2[0],
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", message.error('请输入文件链接'));
            ...
            case 3:
              ...
              return _context.abrupt("return", message.error('请选择上传文件'));
  ...
  var onTryExample = useCallback(function (exampleType) {
    var exampleMap = {
  ...
  return /*#__PURE__*/React.createElement(Modal, {
  ...
  }, /*#__PURE__*/React.createElement("span", null, "\u793A\u4F8B\u6570\u636E\uFF1A"), /*#__PURE__*/React.createElement(Radio.Group, {
    size: "small"
  ...
  }, "Point/Line/Hex/Heat"), /*#__PURE__*/React.createElement(Radio.Button, {
    value: "1",
    onClick: function onClick() {
      return onTryExample(2);
    }
  }, "Trip"), /*#__PURE__*/React.createElement(Radio.Button, {
    value: "1",
    onClick: function onClick() {
      return onTryExample(3);
    }
  }, "Polygon"))), /*#__PURE__*/React.createElement(Form, {
    labelCol: {
      span: 4
    },
    wrapperCol: {
    ...
    optionType: "button",
    buttonStyle: "solid"
  })), form.type === 'url' ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Form.Item, {
    label: "\u6587\u4EF6\u94FE\u63A5"
  }, /*#__PURE__*/React.createElement(Input, {
    value: form.url,
    onChange: function onChange(e) {
    ...
    label: "\u4E0A\u4F20\u6587\u4EF6"
  }, /*#__PURE__*/React.createElement(Upload.Dragger, {
    name: "data",
    accept: ".csv,.json",
    maxCount: 1,
  ...
  }, /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement(InboxOutlined$2, {
    style: {
      fontSize: 40,
      marginBottom: 8
    }
  })), /*#__PURE__*/React.createElement("p", null, "\u53EF\u5C06\u4E0A\u4F20\u6587\u4EF6\u62D6\u62FD\u81F3\u8FD9\u91CC")))));
};
  ...
  return /*#__PURE__*/React.createElement(DragDropContext, {
    ...
    return /*#__PURE__*/React.createElement("div", _objectSpread2({
      ...
      return /*#__PURE__*/React.createElement(Draggable, {
        ...
        return /*#__PURE__*/React.createElement("div", _objectSpread2(_objectSpread2({}, itemProvided.draggableProps), {}, {
          ref: itemProvided.innerRef,
          className: classnames([styles$5.dragItem, className, snapshot.isDragging ? 'is-drag' : null]),
          key: item[keyField],
          onClick: function onClick() {
            return onItemClick === null || onItemClick === void 0 ? void 0 : onItemClick(items[index]);
          }
        }), children(item, /*#__PURE__*/React.createElement("i", _objectSpread2({
          className: classnames(['dpiconfont', 'dpicon-yidong', styles$5.dragIcon])
...
var DataDetailDrawer = function DataDetailDrawer(_ref) {
  ...
  var _useState = useState(currentDatasetId),
      _useState2 = _slicedToArray(_useState, 2),
  ...
  return /*#__PURE__*/React.createElement(Drawer, _objectSpread2(_objectSpread2({}, drawProps), {}, {
    visible: visible,
    bodyStyle: {
      padding: '0 10px'
    },
...
var useListHook = function useListHook(list, setList) {
  var onChange = useCallback(function (newItem) {
  ...
  var onEditName = useCallback(function (newName, _ref) {
    var id = _ref.id,
        oldName = _ref.name;
  ...
  var onDragEnd = useCallback(function (newList) {
  ...
  var onDelete = useCallback(function (_ref2) {
    var id = _ref2.id;
...
var EditName = function EditName(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: classnames([styles$6.editName, className])
    ...
    placeholder: "\u8BF7\u8F93\u5165\u540D\u79F0",
    suffix: /*#__PURE__*/React.createElement(EnterOutlined$2, null)
  }) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    title: name,
    className: styles$6.editNameText
  }, name), /*#__PURE__*/React.createElement(EditOutlined$2, {
...
var ConfigModelContext = /*#__PURE__*/createContext();
...
function DatasetList(_ref) {
  ...
  var _useContext2 = useContext(ConfigModelContext),
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    itemClassName: function itemClassName(item) {
      ...
      return classnames((_classnames = {}, _defineProperty(_classnames, styles$4.appDatasetItem, true), _defineProperty(_classnames, 'is-select', item.id === selectDatasetId), _classnames));
    },
    items: datasetList,
    onDrag: onDragEnd,
    onItemClick: onClick
    ...
    }, /*#__PURE__*/React.createElement(EditName, {
      name: dataset.name,
      onChange: function onChange(newName) {
        return onEditName(newName, dataset);
      }
    }), /*#__PURE__*/React.createElement("div", {
      className: classnames([styles$4.datasetFileName, 'is-link']),
      onClick: function onClick(e) {
        e.stopPropagation();
        setDatasetDetail({
          datasetId: dataset.id,
    ...
    }, /*#__PURE__*/React.createElement("span", null, "\u5171", dataset.data.length, "\u884C\u6570\u636E"), /*#__PURE__*/React.createElement("i", {
      className: "dpiconfont dpicon-right"
    })))));
  }), !datasetList.length && /*#__PURE__*/React.createElement(Empty, {
    image: Empty.PRESENTED_IMAGE_SIMPLE,
    description: "\u6682\u65E0\u6570\u636E\u6E90"
  }), /*#__PURE__*/React.createElement(DataDetailDrawer, {
...
var AppDataset = function AppDataset(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    level: 5
  }, "\u6570\u636E\u6E90"), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(Tooltip, {
    overlay: '添加数据源'
  }, loading ? /*#__PURE__*/React.createElement(Spin, {
    spinning: true
  }) : /*#__PURE__*/React.createElement(Button, {
    type: "text",
    icon: /*#__PURE__*/React.createElement(PlusOutlined$2, null),
    onClick: function onClick() {
      return setAddDatasetVisible(true);
    }
  })))), /*#__PURE__*/React.createElement(DatasetList, {
    className: styles$4.appDatasetContent
  }), /*#__PURE__*/React.createElement(AddDatasetModal, {
...
var useLayer = function useLayer() {
  var _useContext = useContext(ConfigModelContext),
      layerList = _useContext.layerList,
      setLayerList = _useContext.setLayerList;

  var getDefaultConfig = useCallback(function (type) {
    var config = {};
  ...
  var addLayer = useCallback(function (dataset) {
    var id = dataset.id;
    var newLayer = {
  ...
  var copyLayer = useCallback(function (filter) {
    var newFilter = _objectSpread2(_objectSpread2({}, cloneDeep(filter)), {}, {
      id: getRandomId('layer'),
      name: generateUnRepeatValue(layerList, 'name', '图层'),
      order: layerList.length + 1,
      createTime: Date.now()
...
var DatasetModal = function DatasetModal(_ref) {
  ...
  }, props), /*#__PURE__*/React.createElement("div", null, "\u9009\u4E2D\u6570\u636E\u6E90\uFF1A"), /*#__PURE__*/React.createElement(Select, {
    style: {
      width: '100%',
      marginTop: '6px'
    },
...
var FieldSelect = function FieldSelect(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Select, _objectSpread2({
    ...
    return /*#__PURE__*/React.createElement(Option, {
      ...
      title: field.name
    }, field.name), /*#__PURE__*/React.createElement(Tag, {
...
var useCommonHook = function useCommonHook(layer, onChange) {
  ...
  var targetDataset = useMemo(function () {
    return getTargetDataset(layer.datasetId);
  }, [layer.datasetId, getTargetDataset]);
  var targetDatasetFields = useMemo(function () {
  ...
  var onFormChange = useCallback(function (changedConfig) {
    onChange(merge({}, layer, {
...
var RangeWrapper = function RangeWrapper(_ref) {
  ...
  }, "\u57FA\u4E8E\u5B57\u6BB5"), /*#__PURE__*/React.createElement(Form.Item, {
    label: label,
    labelCol: {
      span: 24
    },
  ...
  }, hasField ? /*#__PURE__*/React.createElement(FieldRange, null) : /*#__PURE__*/React.createElement(SingleRange, null)), showField && /*#__PURE__*/React.createElement(Form.Item, {
    label: "\u57FA\u4E8E\u5B57\u6BB5",
    name: [field, 'field']
...
var ColorPicker = /*#__PURE__*/memo(function (props) {
  var onChange = props.onChange,
      value = props.value,
      _props$disable = props.disable,
      disable = _props$disable === void 0 ? false : _props$disable;
  var onChangeComplete = useCallback(function (color) {
    onChange(color.hex);
  }, [onChange, value]);
  return /*#__PURE__*/createElement(Button, {
    ...
    content: /*#__PURE__*/createElement(SketchPicker, {
      color: value,
      disableAlpha: true,
...
var FieldColorPicker = function FieldColorPicker(_ref) {
  var value = _ref.value,
      _onChange = _ref.onChange;
  var colorTypeOptions = useMemo(function () {
  ...
  var _useState = useState(function () {
    var targetType = colorTypeOptions.find(function (option) {
      return COLOR_LIST_MAP[option.value].find(function (colorList) {
        return isEqual(colorList, value);
      });
    });
...
var ColorWrapper = function ColorWrapper(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, displayFieldCheckbox && /*#__PURE__*/React.createElement(Checkbox, {
    className: styles$8.fieldFormCheckbox,
    checked: showField,
    onChange: function onChange(e) {
      return setShowField(e.target.checked);
    ...
    var content = /*#__PURE__*/React.createElement(React.Fragment, null);

    if (!colorField) {
      content = range ? /*#__PURE__*/React.createElement(RangeColorPicker, null) : /*#__PURE__*/React.createElement(ColorPicker, {
        value: DEFAULT_COLOR,
        onChange: function onChange() {}
      });
    } else {
      content = /*#__PURE__*/React.createElement(FieldColorPicker, null);
    }
  ...
  }), showField && /*#__PURE__*/React.createElement(Form.Item, {
    label: "\u57FA\u4E8E\u5B57\u6BB5",
    name: [field, 'field']
  }, /*#__PURE__*/React.createElement(FieldSelect, {
    fields: fields,
...
var PointLayer = function PointLayer(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Form, {
  ...
  }, /*#__PURE__*/React.createElement(LayerTypeSelect, {
    layer: layer,
    onChange: onChange
  }), /*#__PURE__*/React.createElement(Form.Item, {
    label: "\u7ECF\u5EA6",
    ...
    fields: targetDatasetFields
  })), /*#__PURE__*/React.createElement(ColorWrapper, {
    label: "\u586B\u5145\u989C\u8272",
    field: "fillColor",
    form: form,
    fields: targetDatasetFields
  }), /*#__PURE__*/React.createElement(RangeWrapper, {
    label: "\u534A\u5F84",
    field: "radius",
    form: form,
    fields: targetDatasetFields
...
var HeatLayer = function HeatLayer(_ref) {
  ...
  var onFormValueChanged = useCallback(function (changedValues) {
    var ranges = [];
...
var LayerItemConfig = function LayerItemConfig(_ref) {
  ...
  var header = /*#__PURE__*/React.createElement("div", {
  ...
  }, dragIcon, /*#__PURE__*/React.createElement(EditName, {
    name: layer.name,
    ...
    }, "\u66F4\u6539\u6570\u636E\u6E90"), /*#__PURE__*/React.createElement(Menu.Item, {
      key: "copyLayer",
      icon: /*#__PURE__*/React.createElement("i", {
  ...
  var content = useMemo(function () {
    switch (layer.type) {
      case 'point':
        return /*#__PURE__*/React.createElement(PointLayer, {
          layer: layer,
          onChange: _onChange
        });

      case 'line':
        return /*#__PURE__*/React.createElement(LineLayer, {
          layer: layer,
          onChange: _onChange
        });

      case 'trip':
        return /*#__PURE__*/React.createElement(TripLayer, {
          layer: layer,
          onChange: _onChange
        });

      case 'polygon':
        return /*#__PURE__*/React.createElement(PolygonLayer, {
          layer: layer,
          onChange: _onChange
        });

      case 'hex':
        return /*#__PURE__*/React.createElement(HexLayer, {
          layer: layer,
          onChange: _onChange
        });

      case 'heat':
        return /*#__PURE__*/React.createElement(HeatLayer, {
          layer: layer,
          onChange: _onChange
        });
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Collapse, {
    ...
    key: layer.id,
    header: header
  }, content)), /*#__PURE__*/React.createElement(DatasetModal, {
    visible: visible,
...
var AppLayerConfig = function AppLayerConfig() {
  ...
  var _useContext2 = useContext(DatasetModelContext),
  ...
  var displayLayerList = useMemo(function () {
  ...
  var onLayerChange = useCallback(function (oldLayer, newLayer) {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, !displayLayerList.length ? /*#__PURE__*/React.createElement(Empty, {
    description: "\u6682\u65E0\u56FE\u5C42"
  }) : /*#__PURE__*/React.createElement(DragList, {
    ...
    return /*#__PURE__*/React.createElement(LayerItemConfig, {
      layer: layer,
      dragIcon: icon,
      onDelete: onDelete,
...
var useFilter = function useFilter() {
  ...
  var addFilter = useCallback(function (dataset) {
    var id = dataset.id,
  ...
  var copyFilter = useCallback(function (filter) {
    var newFilter = _objectSpread2(_objectSpread2({}, cloneDeep(filter)), {}, {
      id: getRandomId('dataset'),
      name: generateUnRepeatValue(filterList, 'name', '筛选器'),
      order: filterList.length + 1,
...
var FilterValue = function FilterValue(props) {
  ...
  if (field.type === 'number') {
    ...
    content = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Slider, {
      range: true,
      step: 1,
      value: value,
      min: minRange,
...
var FilterItem = function FilterItem(_ref) {
  ...
  var resetFilterProperties = useCallback(function (field) {
  ...
  }, "\u7B5B\u9009\u5B57\u6BB5\uFF1A"), /*#__PURE__*/React.createElement(FieldSelect, {
    size: "small",
    bordered: false,
    fields: fields,
  ...
  }))), /*#__PURE__*/React.createElement(DatasetModal, {
    visible: visible,
    setVisible: setVisible,
...
var AppFilterConfig = function AppFilterConfig() {
  ...
  var displayFilterList = useMemo(function () {
  ...
  }, !displayFilterList.length ? /*#__PURE__*/React.createElement(Empty, {
    description: "\u6682\u65E0\u7B5B\u9009\u5668"
  }) : /*#__PURE__*/React.createElement(DragList, {
...
var AppEdit = function AppEdit(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Tabs, {
    ...
    size: "small",
    style: style
  }, /*#__PURE__*/React.createElement(TabPane$1, {
    tab: /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("i", {
      className: "dpiconfont dpicon-tuceng"
    }), /*#__PURE__*/React.createElement("span", null, "\u56FE\u5C42")),
    key: "\u56FE\u5C42"
  }, /*#__PURE__*/React.createElement(AppLayerConfig, null)), /*#__PURE__*/React.createElement(TabPane$1, {
    tab: /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("i", {
      className: "dpiconfont dpicon-guolvqi"
    }), /*#__PURE__*/React.createElement("span", null, "\u8FC7\u6EE4\u5668")),
    key: "\u8FC7\u6EE4\u5668"
  }, /*#__PURE__*/React.createElement(AppFilterConfig, null)), /*#__PURE__*/React.createElement(TabPane$1, {
    tab: /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("i", {
      className: "dpiconfont dpicon-jiaohu"
    }), /*#__PURE__*/React.createElement("span", null, "\u4EA4\u4E92")),
    key: "\u4EA4\u4E92"
  }, /*#__PURE__*/React.createElement(AppInteractiveConfig, null)));
};
  ...
  try {
    ...
    if (['point', 'heat'].includes(type)) {
      ...
      if (lngField && latField) {
        source.data = featureCollection(data.map(function (item) {
          return point([+item[lngField], +item[latField]], item);
        }));
      }
    }
    ...
    if (type === 'line') {
      ...
      if (startLngField && startLatField && endLngField && endLatField) {
        source.data = featureCollection(data.map(function (item) {
          return lineString([[+item[startLngField], +item[startLatField]], [+item[endLngField], +item[endLatField]]], item);
        }));
      }
    }
    ...
    if (type === 'trip') {
      ...
      if (_geoField) {
        source.data = featureCollection(data.map(function (item) {
          return lineString(getPointList(item[_geoField]), item);
        }));
      }
    }
    ...
    if (type === 'hex') {
      ...
      if (hexId) {
        source.data = featureCollection(data.map(function (item) {
          var pointList = h3ToGeoBoundary(item[hexId]).map(function (item) {
            return item.reverse();
          });
...
var transformProps = function transformProps(layer) {
  ...
  if (layer.type === 'polygon') {
    ...
    var borderProps = cloneDeep(props);
...
var LayerItem = /*#__PURE__*/React.memo(function (_ref) {
  ...
  var LayerComponent = useMemo(function () {
    return LAYER_COMPONENT_MAP[layer.type];
  }, [layer.type]);
  return /*#__PURE__*/React.createElement(React.Fragment, null, propsList.map(function (props, propsIndex) {
    var key = getLayerKey(layer, propsIndex);
    return /*#__PURE__*/React.createElement(ErrorBoundary, {
      key: key
    }, LayerComponent ? /*#__PURE__*/React.createElement(LayerComponent, _objectSpread2(_objectSpread2({
...
var AppLayerList = function AppLayerList() {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, layerConfigList.map(function (config) {
    return /*#__PURE__*/React.createElement(LayerItem, {
      key: config.layer.id,
      config: config
    });
  }));
...
var AppDragPanel = function AppDragPanel(_ref) {
  ...
  var onSidebarResize = useCallback(function () {
  ...
  var onDragMove = useCallback(function (e) {
    if (isDrag) {
      debugger;
  ...
  var onDragUp = useCallback(function () {
    setIsDrag(false);
  }, []);
  useMount(function () {
    onSidebarResize();
  ...
  return /*#__PURE__*/React.createElement("div", {
    ref: dragPanelRef,
    className: classnames([styles$e.appDragPanel, className])
  }, /*#__PURE__*/React.createElement(TopComponent, null), /*#__PURE__*/React.createElement("div", {
    className: styles$e.appDragDragLine
  }, /*#__PURE__*/React.createElement("div", {
    className: classnames((_classnames = {}, _defineProperty(_classnames, styles$e.appDragDragPanel, true), _defineProperty(_classnames, styles$e.appDragDragPanelActive, isDrag), _classnames))
  })), /*#__PURE__*/React.createElement(BottomComponent, null));
};
...
function MapContainer() {
  ...
  var _useContext2 = useContext(MapModelContext),
      mapType = _useContext2.mapType;

  var sidebarRef = useRef(null);
  var sidebarHeaderRef = useRef(null);
  return /*#__PURE__*/React.createElement(AppMap, {
    className: styles.container,
    map: mapType
  }, /*#__PURE__*/React.createElement(AppControl, {
    className: classnames((_classnames = {}, _defineProperty(_classnames, styles.control, true), _defineProperty(_classnames, styles.previewHidden, isPreview), _classnames))
  }), /*#__PURE__*/React.createElement(AppSidebar, {
    ref: sidebarRef,
    className: classnames((_classnames2 = {}, _defineProperty(_classnames2, styles.sidebar, true), _defineProperty(_classnames2, styles.previewHidden, isPreview), _classnames2))
  }, /*#__PURE__*/React.createElement(AppHeader, {
    ref: sidebarHeaderRef
  }), /*#__PURE__*/React.createElement(AppDragPanel, {
    sidebarRef: sidebarRef,
    sidebarHeaderRef: sidebarHeaderRef,
    TopComponent: AppDataset,
    BottomComponent: AppEdit
  })), /*#__PURE__*/React.createElement(AppLayerList, null), isPreview && /*#__PURE__*/React.createElement(ExitPreview, null));
}

var ContextProvider = function ContextProvider(_ref) {
  var children = _ref.children;
  return /*#__PURE__*/React.createElement(MapContext, null, /*#__PURE__*/React.createElement(DatasetContext, null, /*#__PURE__*/React.createElement(MapContext$1, null, /*#__PURE__*/React.createElement(GlobalContext, null, children))));
};

function Container() {
  return /*#__PURE__*/React.createElement(ConfigProvider, {
    locale: zhCN
  }, /*#__PURE__*/React.createElement(ContextProvider, null, /*#__PURE__*/React.createElement(MapContainer, null)));
}
