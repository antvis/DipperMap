...
import type { IDatasetBooleanField, IDatasetField, IDatasetNumberField, IDatasetStringField } from './dataset';
...
export declare type IFilter = INumberFilter | IStringFilter | IBooleanFilter;
