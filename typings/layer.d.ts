...
export declare type ILayerType = 'point' | 'line' | 'trip' | 'polygon' | 'hex' | 'heat';
...
export declare type ILineLayerLineType = 'line' | 'arcmini';
...
export declare type ILayer = IPointLayer | ILineLayer | IPolygonLayer | ITripLayer | IHexLayer | IHeatLayer;
